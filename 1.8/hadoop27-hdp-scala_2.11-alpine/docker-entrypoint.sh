...
LOG4J_FILE_TEMPLATE="${FLINK_HOME}/conf-template/log4j-console.properties"
...
if [ -f "$LOG4J_FILE_TEMPLATE" ]; then
  cp $LOG4J_FILE_TEMPLATE ${FLINK_HOME}/conf/log4j-console.properties
fi
